    ...
    if file:
        ...
        try:
            ...
            download_path = os.path.join(app.config['UPLOAD_FOLDER'],
                                         'transcribed_' + file.filename.split('.')[0] + '.json')
            s3_resource.Bucket('output1-sreeni1').download_file('transcribed_' + file.filename.split('.')[0] + '.json', download_path)
            ...
            return render_template_string(f'''<div class="container mt-5">
                                                <div class="alert alert-success" role="alert">
                                                    ...
                                                    Download the transcribed text: <a href="/uploads/{os.path.basename(download_path)}" download>Download</a>
                                                </div>
